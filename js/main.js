...
nhanVienSV.layDSNV().then(function (res) {
    ...
    for (var i = 0; i < res.data.length; i++) {
        ...
        var nhanVien = new NhanVien(ho, ten, maNV, ngayBatDau, chucVsu);
        DSNV.push(nhanVien);
        taoBang(DSNV);
    }
})
...
function FormValidation() {
   ...
   isValid&= KiemTraRong('ho','thongBaoHo','Vui long nhập họ')&& KiemTraDinhDangChu('ho','thongBaoHo','Vui long nhap chữ') && KiemTraMa();
   isValid&= KiemTraRong('ten','thongBaoTen','Vui long nhập ten')&& KiemTraDinhDangChu('ten','thongBaoTen','Vui long nhap chữ');
}
